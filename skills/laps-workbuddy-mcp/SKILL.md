...
5. Use `laps-mcp status` to diagnose readiness. Explain failures as missing address, incomplete login, missing permission, or unavailable APS service. Do not show command output, protocol details, credentials, or raw errors unless technical diagnosis is explicitly requested.
